...
import com.testutils.testcorridor.service.EmployeeDetailsService;
...
public class EmployeeDetailsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails getEmployeeDetails(@PathVariable("id") Long id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public EmployeeDetails editEmployeeDetails(@PathVariable("id") Long id, @RequestBody EmployeeDetails employeeDetails) throws EntityNotFoundException {
        LOGGER.debug("Editing EmployeeDetails with id: {}" , employeeDetails.getId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployeeDetails(@PathVariable("id") Long id) throws EntityNotFoundException {
