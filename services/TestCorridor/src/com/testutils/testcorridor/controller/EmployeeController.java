...
import com.testutils.testcorridor.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("TestCorridor.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/TestCorridor/Employee")
public class EmployeeController {

    private static final Logger LOGGER = LoggerFactory.getLogger(EmployeeController.class);

    @Autowired
	@Qualifier("TestCorridor.EmployeeService")
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getEmployee(@PathVariable("id") Long id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee editEmployee(@PathVariable("id") Long id, @RequestBody Employee employee) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteEmployee(@PathVariable("id") Long id) throws EntityNotFoundException {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getByLdapUid(@PathVariable("ldapUid") String ldapUid) {
        LOGGER.debug("Getting Employee with uniques key LdapUid");
        return employeeService.getByLdapUid(ldapUid);
    }

    @RequestMapping(value = "/email-active", method = RequestMethod.GET)
    @ApiOperation(value = "Returns the matching Employee with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getByEmailAndActive(@RequestParam("email") String email, @RequestParam("active") boolean active) {
        LOGGER.debug("Getting Employee with uniques key EmailAndActive");
        return employeeService.getByEmailAndActive(email, active);
    }

    @RequestMapping(value = "/employeeCode/{employeeCode}", method = RequestMethod.GET)
    @ApiOperation(value = "Returns the matching Employee with given unique key values.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getByEmployeeCode(@PathVariable("employeeCode") long employeeCode) {
        LOGGER.debug("Getting Employee with uniques key EmployeeCode");
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<EmployeeDetails> findAssociatedEmployeeDetailsesForManagerId(@PathVariable("id") Long id, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeeDetailsesForManagerId");
        return employeeService.findAssociatedEmployeeDetailsesForManagerId(id, pageable);
    }
