...
public interface EmployeeService {
	 ...
	 */
	Employee getById(Long employeeId) throws EntityNotFoundException;
    ...
    /**
	 * Find and return the Employee for given ldapUid  if exists.
	 *
	 ...
	 */
    Employee getByLdapUid(String ldapUid)throws EntityNotFoundException;

    /**
	 * Find and return the Employee for given email  andactive  if exists.
	 *
     ...
     * @throws EntityNotFoundException if no matching Employee found.
	 */
    Employee getByEmailAndActive(String email, boolean active)throws EntityNotFoundException;

    /**
	 * Find and return the Employee for given employeeCode  if exists.
	 *
	 * @param employeeCode value of employeeCode; value cannot be null.
	 * @return Employee associated with the given inputs.
     * @throws EntityNotFoundException if no matching Employee found.
	 */
    Employee getByEmployeeCode(long employeeCode)throws EntityNotFoundException;
	 ...
	 */
	Employee delete(Long employeeId) throws EntityNotFoundException;
    ...
    /*
     * Returns the associated employeeDetailsesForManagerId for given Employee id.
     *
     ...
     * @see Page
     */
    Page<EmployeeDetails> findAssociatedEmployeeDetailsesForManagerId(Long id, Pageable pageable);
