...
public interface EmployeeDetailsService {
    ...
    /*
     * Returns the associated accruedElapsedLeaveses for given EmployeeDetails id.
     *
     * @param employeeId value of employeeId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated AccruedElapsedLeaves instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<AccruedElapsedLeaves> findAssociatedAccruedElapsedLeaveses(Integer employeeId, Pageable pageable);
